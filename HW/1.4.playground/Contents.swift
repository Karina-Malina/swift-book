...
/*Сложность этого алгоритма O(n^2) или Квадратичная, потому что мы имеем два вложенных цикла каждый из которых имеет сложность O(n^2).
 То есть при увеличении массива items на одно значение количество операций будет n в квадрате.
 В данном случае количество операций = 4, если добавим еще одно значение, количество операций станет 9
*/
