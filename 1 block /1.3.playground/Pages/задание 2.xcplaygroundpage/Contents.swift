...
//текст ошибки Value of optional type 'Int?' must be unwrapped to a value of type 'Int'
...
let userAge: Int? = Int(userInputAge)
print(userAge)
//Значение userAge nil, потому что мы не смогли преобразовать строку в Int из-за лишнего символа
...
userInputAge = "34"
//смущает Optional в результате вывода
print(userAge!)
...
//Потому что мы пытаемся принудительно извлечь значение неопционального типа. Принудительное извлечение используется только для опционалов
